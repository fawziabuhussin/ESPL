...
int strncmp1(const char* str1, const char* str2, unsigned int n);
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < argc; i++)
    {
        ...
        if (strncmp1(argv[i], "-o", 2) == 0)
        {
            outfile = fopen(argv[i] + 2, "w");
        }
        if (strncmp1(argv[i], "-i", 2) == 0)
        {
